const OurJourneyCard = ({ year, heading, para, image, left, top, sectionLeft }) => {
  return (
    <div className='2xl:h-[1070px] xl:h-[900px] lg:h-[750px] h-[600px] w-full relative overflow-hidden'>
      <div

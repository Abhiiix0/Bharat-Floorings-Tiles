  ...
  return (
    <section className='relative overflow-hidden'>
      ...
      <div className="relative lg:px-[100px] px-[20px]">
        ...
        <div className='2xl:min-h-[1008px] xl:min-h-[700px] lg:min-h-[600px] h-auto flex lg:flex-row flex-col-reverse justify-between xl:mt-14 xl:mb-28 lg:mt-10 lg:mb-20 mt-6 mb-10'>

...
const ProductCard = ({ Product }) => {
  ...
  return (
    <div className=" border md:border-b-[1px] px-[12%]  3xl:px-[15%] 3xl:h-[931px]">
      <p className="mt-[52px] mb-[18px] text-xl normal-text font-medium tracking-[0.4px]">
        BFT + Designer 2
      </p>
      <Image
        alt="img"
        className=" 3xl:h-[462px] 3xl:w-full w-full  md:w-auto md:h-[350px] object-cover"
        src={selectImg}
      />
      <div className="flex ">
      ...
      <div className="flex normal-text  flex-col   h-[250px] 3xl:h-[322px] justify-between">

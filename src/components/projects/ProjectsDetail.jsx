...
const ProjectsDetail = () => {
  return (
    ...
    <div className="lg:px-[100px] px-[20px] relative">
      <h1 className="big-heading 3xl:mt-[146.4px] 3xl:mb-[124px] 2xl:mt-20 2xl:mb-36 xl:mt-16 xl:mb-28 lg:mb-24 md:mt-14 md:mb-20 mt-14 mb-16">
        Project
      </h1>
     ...
     <div className="flex 3xl:gap-[52px] xl:gap-11 lg:gap-9 gap-8 2xl:h-[60] xl:h-14 lg:h-12 h-10 md:mbb-0 mb-10">

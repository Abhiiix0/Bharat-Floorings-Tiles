  ...
  return (
    <div className="max-w[1920px] mx-auto h-auto z-10 w-full fixed top-[0%] left-[0%] bg-[#ffffff7a] flex justify-center items-center">
      {close ? (
        <div
          ref={imageRef}
          className="w-[90%] mx-auto 2xl:py-10 lg:py-8 md:py-6 py-4 2xl:px-20 lg:px-14 md:px-9 px-7 bg-[#eaeaea] flex md:flex-row flex-col max-w-[1920px]"
        >
            ...
            <div className="w-1/5 hidden md:flex flex-col h-full">
              {EVENTS_SUB_IMAGES.map(({ id, image }) => (
                <img
                  ...
                  className={`h-full w-[calc(100%/${allImages})] ${

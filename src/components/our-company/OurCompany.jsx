...
const OurCompany = ({ journey, management, awards, press, events }) => {
  ...
  return (
    <section className="relative">
      ...
      <div className="bg-[#F4F4F4] lg:pl-[100px] pl-[20px] 3xl:pt-[46px] 3xl:pb-60 xl:pt-10 xl:pb-52 lg:pt-9 lg:pb-40 md:pt-7 md:pb-32 sm:pt-6 sm:pb-24 pt-5 pb-20">
        ...
        <h1 className="small-heading 3xl:mt-[119px] 3xl:mb-28 xl:mt-24 xl:my-20 lg:mt-20 lg:mb-16 md:mt-16 md:mb-12 sm:mt-14 sm:mb-7 mt-11 mb-5 md:text-center 2xl:pr-[10%] pr-[15%]">
          Awards
        </h1>
      ...
      <div className="relative 3xl:pt-[201px] 3xl:pb-[276px] xl:pt-40 xl:pb-56  lg:pt-32 lg:pb-44 md:pt-24 md:pb-36 sm:pt-16 sm:pb-24 pt-12 pb-[59px] lg:px-[100px] pl-[20px] bg-[#304941] text-white">

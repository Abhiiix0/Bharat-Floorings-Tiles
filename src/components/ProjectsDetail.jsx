  ...
  return (
    <section className='relative overflow-hidden'>
      ...
      <div className='lg:px-[100px] px-[20px] relative'>
        <h1 className='big-heading 3xl:mt-[143.4px] 3xl:mb-[124px] 2xl:mt-20 2xl:mb-36 xl:mt-16 xl:mb-28 lg:mb-24 md:mt-14 md:mb-20 mt-14 mb-16'>Project</h1>
        <div className='flex items-center justify-between 2xl:mb-[15px]'>
          <div onClick={() => history.back()} className='w-32 xl:w-36 2xl:w-40 flex gap-1 items-center 2xl:text-base xl:text-sm text-xs cursor-pointer link'>
